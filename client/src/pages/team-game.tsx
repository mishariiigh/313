    ...
    return (
      <div className="min-h-screen p-4">
        <div className="max-w-4xl mx-auto">
          {/* Question Card */}
          <div className="luxury-card p-8 mb-6 text-center">
            <div className="text-sm text-luxury-green mb-4">
              {selectedQuestion.category} - {selectedQuestion.difficulty}
            </div>
            <h1 className="text-3xl font-bold text-luxury-green-dark mb-8">
            ...
            {showHint && selectedQuestion.hint && (
              <div className="luxury-card p-4 mb-6 bg-blue-50 border-blue-200">
            ...
            {showAnswer && (
              <div className="luxury-card p-4 mb-6 bg-green-50 border-green-200">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  🔁 دور الفريق: <span className="font-semibold text-luxury-green">
            ...
            <div className="flex gap-4">
              {gameSession.teams.map((team: string, index: number) => (
                <div key={index} className="text-center">
                  ...
                  <div className="text-2xl font-bold text-luxury-green">
        ...
        <div className="grid grid-cols-6 gap-4">
          {CATEGORIES.map((category) => (
            <div key={category.id} className="space-y-2">
              {/* Category Header */}
              <div className="luxury-card p-4 text-center bg-luxury-green text-white font-bold">
              ...
              {[0, 1, 2, 3, 4, 5].map((index) => {
                ...
                return (
                  <button
                    ...
                    disabled={isUsed}
                    className={`luxury-card w-full h-16 text-center font-bold text-lg transition-all duration-200 ${
                      isUsed
                        ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                        : "bg-luxury-green text-white hover:bg-luxury-green-dark shadow-lg hover:shadow-xl"
                    }`}
                  >
